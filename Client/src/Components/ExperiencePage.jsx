...
const ExperiencePage = () => {
  const projects = [
    {
      title: 'Multimodal Stock Prediction: Using Sentiment and Historical Data to Predict Stock Price Direction',
      description: 'Predicting stock price direction is a complex challenge due to the market\'s sensitivity to both historical trends and real-time sentiment. In this paper, we present a multi-modal deep learning framework that integrates sentiment analysis from financial news with historical stock data to improve stock price direction prediction. We begin by developing individual models: FinBERT with both regression and classification heads for sentiment analysis, and multiple architectures—including a Naive Forecast, Bidirectional LSTM, and Multi-Task Transformer—for historical price prediction. Our final architecture, a Dual-Stream Transformer model, combines both modalities using cross-attention to capture intricate relationships between textual sentiment and time-series patterns. Evaluated on a dataset of diverse S&P 500 stocks, our hybrid model achieved state-of-the-art performance, with up to 97.81% accuracy on next-week price movement prediction. These results highlight the effectiveness of combining financial NLP with engineered technical indicators for robust and interpretable stock forecasting.',
      downloadLink: stockpred,
      githubUrl: 'https://github.com/atiwari18/BuffERT'
    },
    {
      title: 'AI Whiteboard',
